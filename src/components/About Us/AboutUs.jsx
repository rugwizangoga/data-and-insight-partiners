  ...
  return (
    <section className="container mx-auto my-24">
      <div className="w-3/4 mx-auto">
        <p className="text-black font-bold text-[48px] text-center">
          About Us
        </p>
        <p className="text-black text-center text-[18px] py-8">
          DATA & INSIGHT PARTNERS Ltd is a leading company based in Rwanda, specializing in supplying
      ...
      <div className="grid md:grid-cols-3 grid-col-1 gap-[51px] mt-[20px]">
        ...
        <DetailCard
          svg={<DetailCard2 />}
          title="Vision"
          backContent="DATA & INSIGHT PARTNERS aims to be the leading solutions provider for engineering material supplier in Rwanda."
        />
        <DetailCard
          svg={<DetailCard3 />}
          title="Values"
